function [SimInput] = Offpath_Model(CurrentParameters,SimInput)
    ...
    % proton concentration also have units of M^-1.
        ...
        k12_base = k23_base*CurrentParameters(6);
         k25_base = k23_base;
       ...
       %  k(5,2) = k25_base *10^-pK_25 * CurrentParameters(7);
