...
%     DetectionOption = 'Usual Trace Analysis';
    ...
    % fusion events which were recorded.
        ...
        FusionData.BindtoFusionTime = CurrTimeVector(FusionData.BindtoFusionNumFrames)-UniversalData.StandardBindTime;
        ...
        if strcmp(Options.DisplayFigures,'y')
            [FigureHandles] = Draw_Lines_on_Plot(FigureHandles,DockingData,FusionData,UniversalData,TraceGradData,Options);
