function [OffsetFrom2DFit, Noise] = Vesicle_Gaussian_Fit(ImageToFit)
...
%StdevY which will be used in the 2D fit.
    ...
    try
        ...
        CenterYSliceOfImage = ImageToFit(:,round(CentroidYFromCoM))';
    end
...
%I think these values might be used if I were writing a tracking program,
%but since I'm not, I'll just comment them out.
    %newy = ImageToFitSizeY/2-CentroidYFrom2DFit; 
    %newx = ImageToFitSizeX/2 - CentroidXFrom2DFit; 
    %pos_shift = [newx newy];
